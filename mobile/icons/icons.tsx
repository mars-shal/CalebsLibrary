// Icon set — exact port of src/components/Icon.vue:13-54 (39 stroke icons,
// 24×24 viewBox, 1.75px stroke, round caps; `google` multicolor DROPPED —
// no login in v1). Rendered via SvgXml to preserve mixed circle/rect/path
// shapes byte-for-byte. Interaction animation base: PressableIcon
// (scale 0.97 + light haptic); per-icon morphs land per screen (UI.md §4).
